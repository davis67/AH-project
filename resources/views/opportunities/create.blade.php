              ...
              <div class="card-body">
               {{-- {{   var_dump($errors)}} --}}
                  <div class="card-title row">
                    ...
                    <div class=" col-md-8">
                        <a href="{{ route('opportunities.index') }}" style="float:right" class="btn btn-outline-danger btn-sm pull-right"><i class="fa fa-fw fa-eye"></i>View All Opportunities</a>
                      </div>
                     </div>
              <form class="form" method="post" action="{{route('opportunities.store')}}">
                    ...
                    <div class="form-row ">
                      ...
                      <div class="form-group ">
                          ...
                          <select  multiple="multiple" name="assigned_to[]" class="form-control {{ $errors->has('assigned_to') ? ' is-invalid' : '' }} form-control-sm select_multiple" id="assignees">
                      ...
                      <div class="pull-left">
                      <button type="submit" class="btn btn-outline-danger "><i class="fa fa-plus"></i>Add Opportunity</button>
                      </div>
                    </form>
          </div>
        </div>
