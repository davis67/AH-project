...
<div class="modal fade" id="editTask" tabindex="-1"  role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                  <span id="tasks_errors">
                    ...
                    <form id="editTaskForm">
                        <div class="row">
                        <div class="col-md-12">
                            <label>Edit A  Project Task</label>
                        ...
                        <div class="modal-footer">
                          <button type="submit"  class="btn btn-sm btn-outline-danger" data-dismiss ="" >
                              Update
                            </button>
